...
本目录为 **apple-co-work** 的设计与约定文档。上手运行请先看仓库根目录 [README.md](../README.md)。

| 文档 | 用途 |
|------|------|
| [mvp.md](./mvp.md) | 宗旨、验收；§2.7～§2.10 已封 · §2.11 `1.0.0` · §2.12 `1.1.x` · §2.13 `1.2.0` · §2.14 `1.3.0` · §2.15 `1.4.0` **最终封板** |
...
9. **版本纪律**：`0.4.0` 已最终封板；当前发布线 **`1.2.x`**（先改 mvp / data-and-ops 再写代码）。  
