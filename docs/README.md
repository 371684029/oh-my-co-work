...
| 文档 | 用途 |
|------|------|
| [mvp.md](./mvp.md) | 宗旨、验收；`1.x` 已封 · `2.6.0` 已封 · `3.8.0` 已封（3.x）· 当前发布线 `4.2.0`（文档中心 + 检索导出 + 更新/备份恢复） |
...
| 4.x | 规划中：协同文档中心——本地聚合群报告/节点台账，左菜单右内容，默认群模板排序可切时间，公告 MD 可编辑。详见 [docs-4x-plan.md](./docs-4x-plan.md)。 |
