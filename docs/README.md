...
| [crucible-3x-plan.md](./crucible-3x-plan.md) | **3.x 实施计划**：3.0 入口 → 3.1 适配 → 3.2 prompt → 3.3 教程 → **3.4 开熔炉注入** |
...
| 3.x | **3.3.0 已封**：熔炉桌宠、适配、工作流 prompt、Grok 教程；群聊完成即归档 |
