...
| **皆可 Workflow** | Workflow 串起节点与用户，凝聚生产力；人机协同的低代码 / decode |
| **简洁桥梁** | **聊天框 + 流程图**——最克制的信息界面，拒绝堆砌 |

**一句话**：人机交互的聚合可视化平台——用工作流把人、脚本与 Agent 编在同一张台上。
...
| 归档 | 流程完成 **自动归档**；可手动归档/停止 |
| 新任务 | 归档后发送消息 → 同模板空白新任务 |
| 聊天 | **名称可编辑**、**可删除** |
...
| POST | `/sessions/:id/messages` | 发消息（归档则开新任务） |
