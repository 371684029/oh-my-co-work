 ...
 * 优先级：
 * 1. 显式 script.cwd
 * 2. **脚本文件所在目录**（file 模式，以脚本路径为基准，等同双击 bat）
 * 3. 成员/会话/群工作目录
 * 4. process.cwd()
 *
 * @param {{ member?, group?, sessionContext?, scriptCfg?, filePath? }} opts
 *   filePath 须为已解析的绝对路径（若有）
 */
